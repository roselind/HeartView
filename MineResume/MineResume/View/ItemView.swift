...
class ItemView: UIView {
    ...
    init(frame: CGRect,title:String,img:UIImage) {
        ...
        //注册点击事件
        self.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(ItemView.tapHandle(_:))))
        
        //注册拖拽事件
        let pan = UIPanGestureRecognizer(target: self, action: #selector(ItemView.panHandle(_:)));
