...
+ (NSString *)apiStringForReadDetailsWithReadType:(ReadType)readType {
    if (readType == ReadTypeSerial) {
...
+ (NSString *)apiStringForReadWithReadType:(ReadType)readType {
    switch (readType) {
        case ReadTypeEssay:
            return MLBApiEssay;
        case ReadTypeSerial:
            return MLBApiSerial;
        case ReadTypeQuestion:
...
+ (NSString *)apiStringForSearchWithSearchType:(SearchType)type {
    switch (type) {
        case SearchTypeHome:
